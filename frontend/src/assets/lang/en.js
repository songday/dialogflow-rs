export default {
  ...
  flow: {
    ...
    nodesDesc: [
      "Returns the dialog text to the user",
      "Setting up conditions to control where the dialog flow goes",
      "Capture user input and save it to a variable",
      "Jumping between dialog flows, or to an external link",
    ],
    ...
    reset: "Reset",
    changeSaveTip:
      "The flow has been modified, do you need to save it and switch?",
    guideReset:
      "The conversation is over, if you want to start over, please click the button below to restart",
  },
  dialogNode: {
    nodeName: "Dialog node",
    textSource: ["Fixed text", "LLM dynamically generates words"],
    nextSteps: ["Waiting for user response", "Goto next node"],
    errors: [
      "Node name not filled in",
      "Text not filled in",
      "Text was too long",
    ],
    btns: ["Generate fixed text from LLM"],
    form: {
      label: "Text",
  ...
  collectNode: {
    ...
    errors: [
      "Node name not filled in",
      "Collection type not choosed",
      "Saving variable not choosed",
      "Branches were missing",
    ],
  ...
  gotoNode: {
    ...
    errors: [
      "Node name not filled in",
      "No goto type selected",
      "Sub-flow not selected for jumping",
      "No external link to fill in",
    ],
    briefs: [
      "Goto type",
      "Conclusion of dialogues",
  ...
  kb: {
    qa: {
      ...
      addTitle: "Add new QA",
      editTitle: "Edit QA",
      detail: "Detail of QnA",
      test: "Test QnA",
      testPH: "Please input some texts",
      empty: "No QnA pairs yet. Click \"Add QnA pair\" to create one.",
      delConfirm: "Confirm to delete this QnA?",
      table: ["Question", "No. of similar questions", "Answer", "Operations"],
      form: {
        question: "Question",
        questionPH: "The question users may ask",
        similar: "Similar questions",
        similarPH: "A variant phrasing of the question",
        addSimilar: "Add similar question",
        similarTip: "More phrasings improve matching accuracy",
        answer: "Answer",
        answerPH: "The answer given to users",
      },
      rules: {
  ...
  settings: {
    title: "Settings",
    ipNote:
      "At startup, you can override the configured parameters with -ip and -port.",
    ipNote2:
      "If the configured IP address is invalid and the application fails to start, use -rs parameter to reset the configuration.",
    prompt2: "Listening port",
    prompt2_2:
      "When the set port is occupied, automatically randomly select other available ports",
    note: "Modified IP address or ports require a reboot to take effect",
    invalidIp: "Incorrectly set IP address",
    commonSettings: "Common settings",
    listeningIp: "Listening IP addr (v4 or v6)",
    hfDownload: "HuggingFace model downloading settings",
    hfDownloadTip: "These settings apply when downloading model files from HuggingFace.co. Some models (such as Gemma and Llama) require an access token to download.",
    hfAccessToken: "Access token",
    hfAccessTokenHelp: "Used to download models that require authorization on HuggingFace.co. You can create one at https://huggingface.co/settings/tokens.",
  },
  botSettings: {
    ...
    providerOpenAiCompatible: "Online model",
    providerHuggingFace: "Local model",
    ...
    fetchModelListOk: "Fetched {count} models",
    fetchModelListFailed: "Failed to fetch the model list",
    vendorOpenAi: "OpenAI",
    ...
    smtp: {
      ...
      username: "Username",
      password: "Password",
      test: "Test SMTP settings",
      testPassed: "SMTP test passed",
      testFailed: "SMTP test failed",
      emailRegex: "Email verification regex",
      emailRegexHelp: "You can customize the email verification regular expression, or leave it blank and the system will automatically use the general verification rules.",
    },
  },
  var: {
    types: ["String", "Number"],
  ...
  eApi: {
    ...
    detail: {
      ...
      apiName: "Api name",
      apiNamePh: "A name for this API",
      descPh: "Some descriptions of this API",
      ...
      noHeaders: 'No headers yet. Click "Add header" to create one.',
      noQueryParams:
        'No query parameters yet. Click "Add query parameter" to create one.',
      noFormData: 'No form data yet. Click "Add form data" to create one.',
      varSource: "Variable",
      userAgent: "User agent",
      test: "Test (WIP)",
      addHeaderTitle: "Add header parameter",
      addQueryParamTitle: "Add query parameter",
      addFormTitle: "Add POST parameter",
      editHeaderTitle: "Edit header parameter",
      editQueryParamTitle: "Edit query parameter",
      editFormTitle: "Edit POST parameter",
      pName: "Name",
      pValue: "Value",
      constValue: "Const value",
      fromVar: "From a variable",
      selectVar: "Select a variable",
      chooseVar: "Choose a variable",
      insertVar: "Insert a variable",
      edit: "Edit",
      del: "Delete",
      savedTip: "All data has been saved.",
      errTip: "Oops, this is something wrong.",
    },
  },
  home: {
    workspace: "Workspace",
    ...
    demoUnvailableContent:
      'Since there is currently no server to host the backend.<br />But you can <a href="https://github.com/dialogflowai/dialogflow/releases">download</a> this software and try these 3 demonstration dialog flows',
  ...
  guide: {
    ...
    delRoConfirm:
      "Are you sure you want to delete this robot and all its data?",
    robotId: "Robot ID",
    kbDesc:
      "The knowledge base is a comprehensive database for centralized storage and management of knowledge",
    qaDesc:
      "In the Q&A knowledge nodes of the flow, the content from the knowledge base can be used to answer user questions.",
    title1: "Dialog flows",
    nav1: "Click here to create new dialog flow or edit existing flow",
    title2: "Intentions",
    nav2: "Intents management",
    desc2:
      'Intents are used to summarize user input, what purpose does it belong to. For example, "I want to know the weather" belongs to the "Weather Inquiry" intent.',
    intentsDesc:
      'We have built-in "Positive" and "Negative" intentions. If that\'s not enough, you can add your own',
    title3: "Variables",
    nav3: "Variables management",
    desc3:
      "Variables are used to store user input, or external data from HTTP, which is used in the answer of the dialog flow, conditional judgment.",
    eApiTitle: "External APIs call",
    eApiDesc:
      "By using this function, you can send data to external URLs and receive response.",
    httpApiList: "External HTTP API list",
    title4: "Robot settings",
    nav4: "Modify Configurations",
    desc4:
      "Change maximum session idle time, Embedding provider, Email STMP information, etc.",
