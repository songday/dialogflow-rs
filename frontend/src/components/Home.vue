...
<template>
    ...
    >
        <template #reference>
            <el-button
                ...
                type="warning"
                text
                >Found new verion: {{ newVersion }}</el-button
            >
        </template>
        <template #default>
            ...
            <a href="https://github.com/dialogflowai/dialogflow/releases"
                >Go to download</a
            >
        </template>
    </el-popover>
    <div v-show="checkUpdateResult === 2">
        <el-alert
            title="You're using the latest verion."
            type="success"
  ...
  <el-button v-show="checkUpdateResult == 3" type="danger" text>Failed to query update information, please try
    ...
    <div style="margin-left: 50px">
        ...
        <el-space wrap size="large">
            <div
                class="grid-content bg-color-light"
                v-for="n in robots"
                :key="n.robotId"
            >
                <el-result
                    :title="n.robotName"
                    :sub-title="getBotType(n.robotType)"
                >
                    <template #icon>
    ...
    <div>
        <div class="text-center">
            ...
            <a href="https://dialogflowai.github.io/" target="_blank"
                >https://dialogflowai.github.io/</a
            ><br />
    ...
    >
        <el-form :model="robotData">
            <el-form-item
                ...
                prop="robotName"
                :rules="[{ required: true, message: 'Robot name is required' }]"
            >
        ...
        <el-table :data="compareDifferentRobotTypeData">
            ...
            <el-table-column
                ...
                :label="isZhLang ? '大模型聊天节点' : 'Llm chat node streaming'"
                width="200"
            />
        </el-table>
        <template #footer>
